...
A simple and visual web app to track the bugs and fish you’ve caught during your **Animal Crossing speedruns**.

---

##  Features

-  Track bugs and fish across multiple games: (GameCube / Wild World / City Folk / New Leaf / New Horizons)
...
- Different games and categories have separate progress tracking
